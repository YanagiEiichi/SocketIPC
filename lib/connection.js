...
class Connection {
  ...
  callWithTimeout({ method, timeout = this.timeout }, params) {
    return this._call({ method, timeout }, params);
  }

  call(method, params) {
    return this._call({method, timeout: null}, params);
  }

  _call(options, params) {
